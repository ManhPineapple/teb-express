      ...
      <ResizablePanel defaultSize={30}>
        {/* <div className=" h-[200px] items-center justify-center p-6">
          ...
          <div className="grid grid-cols-12 my-2">
            <div className="col-span-4 font-normal text-[#626363]">Detail:</div>
          ...
          <div className="grid grid-cols-12 mb-2">
            <div className="col-span-4 font-normal text-[#626363]">Weight:</div>
            <div className="col-span-8">{packageDetail?.weight} gram</div>
          </div>
          <div className="grid grid-cols-12 mb-2">
            <div className="col-span-4 font-normal text-[#626363]">Length:</div>
            <div className="col-span-8"> {packageDetail?.length} cm</div>
          </div>
          <div className="grid grid-cols-12 mb-2">
            <div className="col-span-4 font-normal text-[#626363]">Width:</div>
            <div className="col-span-8"> {packageDetail?.width} cm</div>
          </div>
          <div className="grid grid-cols-12 mb-2">
            <div className="col-span-4 font-normal text-[#626363]">Height:</div>
          ...
          <ResizablePanel defaultSize={43}>
            <div className="flex h-full p-6 justify-between">
              <div>
                ...
                <div>
                  <span className="text-5xl font-bold rounded-2xl capitalize">
                    {packageDetail?.status_string}
                  </span>
                </div>
                <div className="font-bold">
                  as on{" "}
                  <span className="font-bold text-sm tracking-[.2px] text-[#111212]">
                    {packageDetail?.created_at
                      ? format(
                          new Date(packageDetail.created_at),
                          "dd/MM/yyyy - HH:mm:ss"
                  ...
                  {packageDetail?.package_products &&
                    packageDetail?.package_products?.length > 0 && (
                      <div>
                        ...
                        {packageDetail?.package_products.map(
                          (product, index) => (
